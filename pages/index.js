...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>TotoB12 Gen 2</title>
        <meta name="description" content="TotoB12 Gen interface" />
      ...
      <div className={styles.topnav}>
        ...
        <div className={styles.navlinks}>
          ...
          <a href="https://totob12.github.io" target="_blank">Home</a>
        </div>
      </div>
      <main className={styles.main}>
        ...
        <div className={styles.center}>
          ...
          <div className={styles.footer}>
            <p>Powered by <a href="https://totob12.github.io/" target="_blank">TotoB12</a>. Built on <a href="https://en.wikipedia.org/wiki/Crack_cocaine" target="_blank">Crack</a>.</p>
          </div>
        </div>
      </main>
    </>
